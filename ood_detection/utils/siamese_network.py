...
from .resnet_small_pytorch import resnet20
...
def create_wide_resnet_based_shared_model(
    shared_model_name, dataset_name, num_classes, version=1
):
    shared_model = None
...
def create_siamese_network_wrapper(
    dataset_name,
    shared_model_name,
    load_to_gpu,
    version=1,
    ...
    if shared_model_name.find("WideResNet") >= 0:
        shared_model = create_wide_resnet_based_shared_model(
        ...
        shared_model = create_resnet_based_shared_model(
            dataset_name=dataset_name,
            shared_model_name=shared_model_name,
            version=version,
            num_classes=num_classes,
    ...
    siamese_net = createSiameseNetwork(
        ...
        siamese_network_version=version,
        temp=temp,
