# citation:
# 1. https://github.com/wetliu/energy_ood/blob/master/utils/score_calculation.py
# 2. https://github.com/hendrycks/outlier-exposure/blob/master/utils/display_results.py
...
def get_Mahalanobis_score(
    ...
    for batch_idx, (data, target) in enumerate(test_loader):
        ...
        pure_gau = (
            -0.5
            * torch.mm(torch.mm(zero_f, Variable(precision[layer_index])), zero_f.t()).diag()
        )
        ...
        with torch.no_grad():
            noise_out_features = model.intermediate_forward(tempInputs)
